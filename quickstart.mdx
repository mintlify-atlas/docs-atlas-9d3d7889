...
<CardGroup cols={2}>
  <Card title="Core concepts" icon="book" href="/core/data-items">
    Deep dive into TDataItem and TeeBI architecture
  </Card>
  <Card title="Importing data" icon="file-import" href="/import/overview">
    Learn all the ways to import data into TeeBI
  </Card>
  <Card title="Querying data" icon="magnifying-glass" href="/queries/overview">
    Master SQL-like queries and data transformations
  </Card>
  <Card title="Visualization" icon="chart-bar" href="/visualization/overview">
